...
<div id="top" style="border:0px solid #000;"> 
	...
	<ul id="lnb">
		<c:choose>
			...
			<c:when test="${not empty sessionScope.USER_ID }">	
				<!-- 로그인후 -->
				<!-- 인클루드 되있는 탑에서 로그아웃을 할 시 현재 위치의 URL을 받아서 로그아웃 해도 현재 페이지에 머무룰 수 있게 만들어보자.. -->
	...
	<map name="GNB">
		...
		<area shape="rect" alt="" title="" coords="536,0,638,33" href="../community/community.do?bname=staffDataroom" target="" />
