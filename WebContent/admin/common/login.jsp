...
<body class="bg-dark">
  ...
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
        <form action="../../admin/common/adminLogin.do" name="loginfrm" method="post">
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" name="inputId" class="form-control" placeholder="Email address" required="required" autofocus="autofocus">
