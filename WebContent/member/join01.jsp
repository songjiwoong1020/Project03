...
<%@ include file="../include/global_head.jsp" %>
	...
	<div id="wrap">
		...
		<div class="contents_box">
			...
			<div class="right_contents">
				...
				<p style="text-align:center; margin-bottom:20px"><a href="javascript:check();"><img src="../images/btn01.gif" /></a>&nbsp;&nbsp;<a href="#"><img src="../images/btn02.gif" /></a></p>
 ...
 <script>
 	function check(){
 		var agree = document.getElementsByName('agreement1')[0];
